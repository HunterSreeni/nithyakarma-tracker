...
describe('LearningHub', () => {
  it('lists every learning-enabled practice, linking to its own reader route', () => {
    ...
    expect(screen.getByText('Dakshinamurthy Stotram').closest('a')).toHaveAttribute('href', '/learning/dakshinamurthy-stotram')
    expect(screen.getByText('Aditya Hrudayam').closest('a')).toHaveAttribute('href', '/learning/aditya-hrudayam')
    expect(screen.getByText('Subrahmanya Bhujangam').closest('a')).toHaveAttribute('href', '/learning/subrahmanya-bhujangam')
    expect(screen.getByText('Mukundamala').closest('a')).toHaveAttribute('href', '/learning/mukundamala')
    expect(screen.getByText('Sri Rudram').closest('a')).toHaveAttribute('href', '/learning/sri-rudram')
    expect(screen.getByText('Sandhyavandhanam').closest('a')).toHaveAttribute('href', '/learning/sandhyavandhanam')
    expect(screen.getByText('Samidhadhanam').closest('a')).toHaveAttribute('href', '/learning/samidhadhanam')
  })
})
